export function EmergencyButton() {
  return (
    <div className="fixed bottom-8 right-8 z-50 group hidden md:block">
      ...
      <button className="bg-red-500 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl shadow-red-500/40 hover:scale-110 active:scale-95 transition-all">
